<div id="signinModal" x-data="signinForm()" class="hidden fixed inset-0 backdrop-blur-lg bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center p-4">
        ...
        async submitSignin() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.errors) {
                        this.errors.email = data.errors.email?.[0] || data.message || 'Invalid credentials';
                    } else {
                        this.errors.email = data.message || 'Invalid credentials';
                    }
                }
            } catch (error) {
