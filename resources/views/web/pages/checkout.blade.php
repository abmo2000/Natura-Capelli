  ...
  <div class="container mx-auto px-3 sm:px-4">
    ...
    <div class="max-w-2xl mx-auto">
      <div class="bg-gray-800 bg-opacity-95 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-xl border border-gray-700 p-4 sm:p-6 md:p-8">
        ...
        <div x-show="success" x-cloak  x-transition class="mb-4 bg-green-900 border border-green-700 text-green-200 px-4 py-3 rounded-lg">
        ...
        <form x-on:submit.prevent="submitOrder" class="space-y-5 sm:space-y-6">
          @csrf
...
@push('scripts_bottom')
    ...
    <script src="https://polyfill.io/v3/polyfill.min.js?features=default,Array.prototype.includes,Object.entries,Promise"></script>
